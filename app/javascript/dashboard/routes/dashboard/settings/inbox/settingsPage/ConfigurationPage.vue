...
<template>
  ...
  <div v-else-if="isAnEmailChannel">
    ...
    <!-- bloco adicionado para Evolution -->
  <div v-else-if="isAEvolutionChannel" class="mx-8">
    <SettingsSection
      :title="$t('INBOX_MGMT.ADD.EVOLUTION.FINISH_QR_TITLE')"
      :sub-title="$t('INBOX_MGMT.ADD.EVOLUTION.FINISH_QR_INSTRUCTION')"
    >
      <!-- Exibe o QR code que veio em provider_config.qrcode -->
      <woot-code :script="inbox.provider_config.qrcode" lang="html" />
    </SettingsSection>
  </div>
