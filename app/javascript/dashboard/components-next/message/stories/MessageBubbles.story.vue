...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about connect?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://connect.dev/invoice.pdf'),
      getAttachment('file', 'https://connect.dev/logs.txt'),
      getAttachment('file', 'https://connect.dev/contacts.xls'),
      getAttachment('file', 'https://connect.dev/customers.csv'),
      getAttachment('file', 'https://connect.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://connect.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://connect.dev/all-files.tar'),
      getAttachment(
        'audio',
